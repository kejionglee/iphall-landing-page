      ...
      <div className="container px-4">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
            Five integrated modules covering the complete patent lifecycle from search to commercialization
          </p>
        </div>

        <div className="flex flex-wrap justify-center gap-6">
          {features.map((feature, index) => (
            <Card key={index} className="group w-full max-w-sm p-6 transition-all hover:shadow-lg hover:shadow-primary/5 md:w-[calc(50%-0.75rem)] lg:w-[calc(33.333%-1rem)]">
